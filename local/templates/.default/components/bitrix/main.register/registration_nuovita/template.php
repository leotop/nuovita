...
<?echo GetMessage("main_profile_time_zones_auto")?><?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="bx-authform-starrequired">*</span><?endif?>
    ...
    <?else:?>
            <?=GetMessage("REGISTER_FIELD_".$FIELD)?>:<?if ($arResult["REQUIRED_FIELDS_FLAGS"][$FIELD] == "Y"):?><span class="bx-authform-starrequired">*</span><?endif?>
            <?
    switch ($FIELD)
    {
        case "PASSWORD":
